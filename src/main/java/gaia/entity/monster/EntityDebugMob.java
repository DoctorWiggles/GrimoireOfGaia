...
public class EntityDebugMob extends EntityMobHostileDay {
	...
	protected void dropLoot(boolean wasRecentlyHit, int lootingModifier, DamageSource source)
    {
		...
		drop_A_Random_Loot_From_LootTable(LootTableList.CHESTS_END_CITY_TREASURE, wasRecentlyHit, lootingModifier, source);
		
		/**We could setup multiples to work in conjunction via randoms and more control statements 
		 * Or we could just use the control statements to adjust the chance the mob would attempt to drop seomthing from that pool**/
	...
	public void drop_A_Random_Loot_From_LootTable(ResourceLocation dungeonLoot, boolean wasRecentlyHit, int lootingModifier, DamageSource source){
