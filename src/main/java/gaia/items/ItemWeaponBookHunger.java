...
public class ItemWeaponBookHunger extends ItemSword {
	...
	public ItemWeaponBookHunger(String texture) {
		...
		this.setUnlocalizedName("GrimoireOfGaia.WeaponBookHunger");
	...
	public boolean hitEntity(ItemStack itemstack, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving) {
		...
		par2EntityLiving.addPotionEffect(new PotionEffect(Potion.hunger.id, 80, 0));
		return true;
	}
