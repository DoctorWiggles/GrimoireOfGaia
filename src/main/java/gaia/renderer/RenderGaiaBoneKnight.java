...
public class RenderGaiaBoneKnight extends RenderLiving {

	private static final ResourceLocation texture = new ResourceLocation("gaia", "textures/models/Bone_Knight.png");

	public RenderGaiaBoneKnight(RenderManager rend) {
		super(rend, new ModelGaiaBoneKnight(), 0.5F);
	}
	...
	protected void renderEquippedItems(EntityLivingBase par1EntityLiving, float par2) {
		...
		if(var4 != null) {
			GL11.glPushMatrix();
			ModelGaiaBoneKnight.rightgauntlet.postRender(0.0625F);
