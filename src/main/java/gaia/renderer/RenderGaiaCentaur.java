...
public class RenderGaiaCentaur extends RenderLiving {

	private static final ResourceLocation texture = new ResourceLocation("gaia", "textures/models/Centaur.png");

	public RenderGaiaCentaur(RenderManager rend) {
		super(rend, new ModelGaiaCentaur(), 0.5F);
	}
	...
	protected void renderEquippedItems(EntityLivingBase par1EntityLiving, float par2) {
		...
		if(var4 != null) {
			GL11.glPushMatrix();
			ModelGaiaCentaur.rightarm.postRender(0.0625F);
