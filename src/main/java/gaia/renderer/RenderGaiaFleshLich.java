...
public class RenderGaiaFleshLich extends RenderLiving {

	private static final ResourceLocation texture = new ResourceLocation("gaia", "textures/models/Flesh_Lich.png");

	public RenderGaiaFleshLich(RenderManager rend) {
		super(rend, new ModelGaiaFleshLich(), 0.5F);
	}
	...
	protected void renderEquippedItems(EntityLivingBase par1EntityLiving, float par2) {
		...
		if(var4 != null) {
			GL11.glPushMatrix();
			ModelGaiaFleshLich.rightarm.postRender(0.0625F);
