...
public class RenderGaiaShaman extends RenderLiving {

	private static final ResourceLocation texture = new ResourceLocation("gaia", "textures/models/Shaman.png");

	public RenderGaiaShaman(RenderManager rend) {
		super(rend, new ModelGaiaShaman(), 0.5F);
	}
	...
	protected void renderEquippedItems(EntityLivingBase par1EntityLiving, float par2) {
		...
		if(var4 != null) {
			GL11.glPushMatrix();
			ModelGaiaShaman.rightarm.postRender(0.0625F);
